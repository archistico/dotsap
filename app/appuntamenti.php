...
class Appuntamenti
{
    ...
    public function TabellaGiorno($f3, $params)
    {
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '8:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '8:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '9:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '9:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '10:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '10:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '11:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '11:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '12:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '12:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '13:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '13:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '14:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '14:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '15:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '15:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '16:40', '', false));
        $listaOrari->Add(new \App\Orario('Lunedì', '16:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '17:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Lunedì', '17:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Lunedì', '18:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Lunedì', '18:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '8:40', '', false));
        $listaOrari->Add(new \App\Orario('Martedì', '8:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '9:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Martedì', '9:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '10:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Martedì', '10:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '11:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Martedì', '11:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '12:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Martedì', '12:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '13:40', '', false));
        $listaOrari->Add(new \App\Orario('Martedì', '13:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '14:40', '', false));
        $listaOrari->Add(new \App\Orario('Martedì', '14:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '15:40', '', false));
        $listaOrari->Add(new \App\Orario('Martedì', '15:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '16:40', '', false));
        $listaOrari->Add(new \App\Orario('Martedì', '16:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '17:40', '', false));
        $listaOrari->Add(new \App\Orario('Martedì', '17:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Martedì', '18:40', '', false));
        $listaOrari->Add(new \App\Orario('Martedì', '18:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '8:40', '', false));
        $listaOrari->Add(new \App\Orario('Mercoledì', '8:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '9:40', 'Chatillon', true));
        $listaOrari->Add(new \App\Orario('Mercoledì', '9:50', 'Chatillon', true));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '10:40', 'Chatillon', true));
        $listaOrari->Add(new \App\Orario('Mercoledì', '10:50', 'Chatillon', true));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '11:40', 'Chatillon', true));
        $listaOrari->Add(new \App\Orario('Mercoledì', '11:50', 'Chatillon', true));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '12:40', 'Chatillon', true));
        $listaOrari->Add(new \App\Orario('Mercoledì', '12:50', 'Chatillon', true));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '13:40', '', false));
        $listaOrari->Add(new \App\Orario('Mercoledì', '13:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '14:40', '', false));
        $listaOrari->Add(new \App\Orario('Mercoledì', '14:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '15:40', '', false));
        $listaOrari->Add(new \App\Orario('Mercoledì', '15:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '16:40', '', false));
        $listaOrari->Add(new \App\Orario('Mercoledì', '16:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '17:40', '', false));
        $listaOrari->Add(new \App\Orario('Mercoledì', '17:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Mercoledì', '18:40', '', false));
        $listaOrari->Add(new \App\Orario('Mercoledì', '18:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '8:40', '', false));
        $listaOrari->Add(new \App\Orario('Giovedì', '8:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '9:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Giovedì', '9:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '10:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Giovedì', '10:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '11:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Giovedì', '11:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '12:40', 'Saint-Vincent', true));
        $listaOrari->Add(new \App\Orario('Giovedì', '12:50', 'Saint-Vincent', true));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '13:40', '', false));
        $listaOrari->Add(new \App\Orario('Giovedì', '13:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '14:40', '', false));
        $listaOrari->Add(new \App\Orario('Giovedì', '14:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '15:40', '', false));
        $listaOrari->Add(new \App\Orario('Giovedì', '15:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '16:40', '', false));
        $listaOrari->Add(new \App\Orario('Giovedì', '16:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '17:40', '', false));
        $listaOrari->Add(new \App\Orario('Giovedì', '17:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Giovedì', '18:40', '', false));
        $listaOrari->Add(new \App\Orario('Giovedì', '18:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '8:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '8:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '9:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '9:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '10:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '10:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '11:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '11:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '12:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '12:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '13:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '13:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '14:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '14:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '15:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '15:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '16:40', '', false));
        $listaOrari->Add(new \App\Orario('Venerdì', '16:50', '', false));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '17:40', 'Pontey', true));
        $listaOrari->Add(new \App\Orario('Venerdì', '17:50', 'Pontey', true));
        ...
        $listaOrari->Add(new \App\Orario('Venerdì', '18:40', 'Pontey', true));
        $listaOrari->Add(new \App\Orario('Venerdì', '18:50', 'Pontey', true));
